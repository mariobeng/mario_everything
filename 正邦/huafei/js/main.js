...
function Qp_x() {
	...
	this.tmbg = new createjs.Bitmap(qipaStage.queue.getResult("gameback3"));
	this.tmbg.x = 0;
	this.tmbg.y = 0;
...
function qp_w() {
	...
	this.tmbg.x = 0;
	this.tmbg.y = 0;
	qipaStage.stage.addChild(this.tmbg);
...
function Qp_C() {
	...
	b.on("click",
	function(a) {
		$("div.success, #lingqu").show();
		var tel = $("input.telphone");
		...
		$("a.chongxin").click(function(){
			$("div.shibai").hide();
			$("#lingqu").show();
		})
		$("a.yici").click(function(){
			location.reload();
		})
		/*qp_p();
		qipaStage.stage.gameover.visible = !1*/
	...
	/*this.addChild(c);*/
	this.addChild(d);
	this.scoreText = new createjs.Text("", "bold 1px Arial", "#EB4A4F");
	this.scoreText.textAlign = "center";
	this.scoreText.x = W / 2;
	this.scoreText.y = a.y + 50;
	this.addChild(this.scoreText);
	this.shareText = new createjs.Text("", "38px Arial", "#EB4A4F");
...
function qp_u() {
	...
	if (0 == qipaApp.score) qipaShare.desc = qipaShare.title;
		...
		99 < a && (a = "99.9");
		qipaShare.desc = "\u606d\u559c\u4f60\u6570\u4e86" + qipaApp.score + "\u5143\u94b1\uff01\n\n\u571f\u8c6a\u6c42\u62b1\u5927\u817f\uff0c\u70b9\u51fb\u9886\u53d6\u5956\u52b1\u5427"
	}
